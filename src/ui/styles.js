...
@media (min-width: 768px) {
  .mode-bar { max-width: 520px; margin-left: auto; margin-right: auto; }
}
...
.mode-btn.on {
  ...
  color: var(--accent-primary);
  box-shadow: inset 0 0 0 1px var(--accent-primary), 0 0 12px var(--accent-action-glow);
