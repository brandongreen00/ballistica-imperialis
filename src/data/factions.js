...
export const FACTIONS = [
...

  {
    ...
    short: "HEARTHKYN",
    attacker_effects: ["grudge_token"],
    defender_effects: ["sturdy", "wrought_defence"],
    operatives: [
      {
        id: "hks-theyn",
        name: "Theyn",
        full_name: "HEARTHKYN THEYN",
        save: 3, wounds: 9, apl: 2, move: "5\"",
        defender_abilities: [],
        attacker_effects: [],
        weapons: [
          { name: "Autoch-pattern bolt pistol", atk: 4, hit: 3, normal_dmg: 3, crit_dmg: 4, rules: ["Range 8\"", "Accurate 1"], is_pistol: true },
      ...
      },
      {
        id: "hks-dozr",
        name: "Dôzr",
        full_name: "HEARTHKYN DÔZR",
        save: 3, wounds: 8, apl: 2, move: "5\"",
        defender_abilities: [],
        attacker_effects: [],
        weapons: [
      ...
      },
      {
        id: "hks-field-medic",
        name: "Field Medic",
        full_name: "HEARTHKYN FIELD MEDIC",
        save: 3, wounds: 8, apl: 2, move: "5\"",
        defender_abilities: [],
        attacker_effects: [],
        weapons: [
      ...
      },
      {
        id: "hks-grenadier",
        name: "Grenadier",
        full_name: "HEARTHKYN GRENADIER",
        save: 3, wounds: 8, apl: 2, move: "5\"",
        defender_abilities: [],
        attacker_effects: [],
        weapons: [
          { name: "Autoch-pattern bolt pistol", atk: 4, hit: 4, normal_dmg: 3, crit_dmg: 4, rules: ["Range 8\"", "Accurate 1"], is_pistol: true },
          { name: "C8 HX charge", atk: 4, hit: 3, normal_dmg: 4, crit_dmg: 6, rules: ["Range 4\"", "Blast 1\"", "Heavy (Reposition only)", "Limited", "Piercing 1", "Saturate"], is_pistol: false },
        ],
      },
      {
        id: "hks-gunner",
        name: "Gunner",
        full_name: "HEARTHKYN GUNNER",
        save: 3, wounds: 8, apl: 2, move: "5\"",
        defender_abilities: [],
        attacker_effects: [],
        weapons: [
          { name: "EtaCarn plasma beamer", atk: 4, hit: 4, normal_dmg: 5, crit_dmg: 6, rules: ["Piercing 1", "Beam"], is_pistol: false },
          { name: "HYLas auto rifle", atk: 4, hit: 4, normal_dmg: 4, crit_dmg: 5, rules: ["Ceaseless", "Rending"], is_pistol: false },
          { name: "HYLas rotary cannon (focused)", atk: 5, hit: 4, normal_dmg: 4, crit_dmg: 5, rules: ["Ceaseless", "Heavy (Reposition only)", "Saturate"], is_pistol: false },
          { name: "HYLas rotary cannon (sweeping)", atk: 4, hit: 4, normal_dmg: 4, crit_dmg: 5, rules: ["Ceaseless", "Heavy (Reposition only)", "Saturate", "Torrent 1\""], is_pistol: false },
      ...
      {
        id: "hks-jump-pack-warrior",
        name: "Jump Pack Warrior",
        full_name: "HEARTHKYN JUMP PACK WARRIOR",
        save: 3, wounds: 8, apl: 2, move: "8\"",
        defender_abilities: [],
        attacker_effects: [],
        weapons: [
          { name: "Autoch-pattern bolt pistol", atk: 4, hit: 4, normal_dmg: 3, crit_dmg: 4, rules: ["Range 8\"", "Accurate 1"], is_pistol: true },
